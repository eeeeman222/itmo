...
public class Route extends Element implements Validatable {
    ...
    public Route(long id, String name, Coordinates coordinates, LocalDateTime creationDate, Location from, Place to, int distance, long creatorId) {
        this.id = id;
        this.name = name;
    ...
    public Route(long id, String name, Coordinates coordinates, Location from, Place to, int distance, long creatorId) {
        this(id, name, coordinates, LocalDateTime.now(), from, to, distance, creatorId);
    }
    @Override
