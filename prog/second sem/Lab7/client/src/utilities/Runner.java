...
public class Runner {
    ...
    public Runner(UDPClient client, MyConsole console) {
        ...
        this.commands = new HashMap<>() {{
            ...
            put(Commands.AUTHENTICATE, new Authorizate(console, client));
        }};
    }
    ...
    private void scriptMode(String argument) throws Asker.AskBreak, ClassNotFoundException {
        ...
        public void launchCommand (String[]userCommand) throws Asker.AskBreak, ClassNotFoundException, IOException {
